...
# Add local dev origins only in non-production
...
# Routers
# ---------------------------------------------------------------------------
from api.v1.router import api_router          # ← was commented out before
app.include_router(api_router, prefix="/api/v1")  # ← was commented out before
